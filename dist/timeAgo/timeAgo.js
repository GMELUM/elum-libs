...
const decWord_1 = __importDefault(require("../decWord/decWord"));
const timeAgo = (timestamp) => {
    ...
    const lasing = (title, end, count) => Array.isArray(title) ? `${count} ${(0, decWord_1.default)(count, title)} ${end}` : `${title} ${end}`;
    switch (true) {
